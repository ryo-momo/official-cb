...
exports.survey_contents = void 0;
const config_1 = require("./config");
const flex_message_content_1 = require("./flex_message_content");
const user_columns = config_1.db_data.tables.users.columns;
const reiwa_year = 6;
exports.survey_contents = {
    surveys: [
        {
            id: 'basic_info',
            questions: [
            ...
            questions: [
                {
                    ...
                    type: 'single-choice',
                    related_table: config_1.db_data.tables.users.name,
                    related_column: config_1.db_data.tables.users.columns.desired_price,
                    design: (_a = flex_message_content_1.flex_message_contents.find((flex_message_content) => flex_message_content.id === 'property_conditions_price')) === null || _a === void 0 ? void 0 : _a.design,
                    options: [
                        {
                            id: 1,
                            text: '3000～5000万円',
                ...
                },
                {
                    ...
                    type: 'single-choice',
                    related_table: config_1.db_data.tables.users.name,
                    related_column: config_1.db_data.tables.users.columns.desired_area,
                    design: (_b = flex_message_content_1.flex_message_contents.find((flex_message_content) => flex_message_content.id === 'property_conditions_area')) === null || _b === void 0 ? void 0 : _b.design,
                    options: [
                        {
                            id: 1,
                            text: '東京都（城北エリア）',
                ...
                },
                {
                    ...
                    type: 'single-choice',
                    related_table: config_1.db_data.tables.users.name,
                    related_column: config_1.db_data.tables.users.columns.desired_yield,
                    design: (_c = flex_message_content_1.flex_message_contents.find((flex_message_content) => flex_message_content.id === 'property_conditions_yield')) === null || _c === void 0 ? void 0 : _c.design,
                    options: [
                        {
                            id: 1,
                            text: '4％～（RC造 築浅中心）',
